            ...
            <div className="card-body p-0">
              {settingsTabs.map(tab => (
                <button
                  ...
                  className={`w-100 text-start px-4 py-3 border-0 bg-transparent d-flex align-items-center gap-3 transition-all ${
                    activeTab === tab.id 
                      ? 'bg-primary text-white border-start border-4 border-primary' 
                ...
                >
                  <span style={{ color: activeTab === tab.id ? 'white' : '#6c757d' }}>
                    {tab.icon}
                  </span>
